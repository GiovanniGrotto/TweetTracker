const socket = io("https://site202139.tw.cs.unibo.it/") // non so perchè ma questa cosa va fatta e va bene così
...
function closeStream() {
    $.ajax({
        type: 'GET',
        async: false,
        url: "https://site202139.tw.cs.unibo.it/" + "stream/closing",
        crossDomain: true,
        success: function() {
            console.log("Closed");
...
//     location.href = "https://site202139.tw.cs.unibo.it/streamclosing";
