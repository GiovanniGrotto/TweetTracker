function func() {
    ...
    if (document.getElementById('loc').checked) {
        url = 'https://site202139.tw.cs.unibo.it/' + searchby + '/' + text + '/' + orderby + '/' + maxt + '/' + radius;
    } else {
        url = 'https://site202139.tw.cs.unibo.it/' + searchby + '/' + text + '/' + orderby + '/' + maxt;
    }
...
async function get_data_from_id(id) {
    url = 'https://site202139.tw.cs.unibo.it/tweetById/' + id;
