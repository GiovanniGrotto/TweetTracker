...
function getUserTweet() {
    ...
    //url = "https://site202139.tw.cs.unibo.it/searchbyUser/" + text + "/mixed/100";
    url = "https://site202139.tw.cs.unibo.it/searchbyUser/" + text + "/mixed/50";
    return new Promise(async function(resolve, reject) {
        await $.ajax({
            type: 'GET',
            url: url,
...
function tweetGeo(id) {
    //let url2 = 'https://site202139.tw.cs.unibo.it/tweetById/' + id;
    let url2 = "https://site202139.tw.cs.unibo.it/tweetById/" + id;
